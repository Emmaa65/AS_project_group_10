  ...
  max_ang_a_(0.0)
{
  ...
  // Declare and get max_v and max_a parameters
  ...
  RCLCPP_INFO(node_->get_logger(), "Loaded parameters: max_v=%.2f, max_a=%.2f", 
              max_v_, max_a_);
  //
  // ~~~~ end solution
  // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  mav_trajectory_generation::Trajectory * trajectory)
{
  ...
  // more for the other (new) waypoints
  ...
  middle.addConstraint(mav_trajectory_generation::derivative_order::POSITION,
                      Eigen::Vector3d(-100.0, 10.0, 14.0));
