...
def generate_launch_description():
    ...
    static_tf_nodes = [
        ...
        Node(
            ...
            executable="static_transform_publisher",
            name="camera_to_body",
            arguments=["--x", "0.1", "--y", "0", "--z", "0", "--qx", "0", "--qy", "0", "--qz", "0", "--qw", "1", "--frame-id", "true_body", "--child-frame-id", "camera"],
            output="screen",
        ),
        Node(
            package="tf2_ros",
            ...
            arguments=["--x", "0.1", "--y", "0", "--z", "0", "--qx", "0", "--qy", "0", "--qz", "0", "--qw", "1", "--frame-id", "true_body", "--child-frame-id", "depth_camera"],
            output="screen",
        ),
        Node(
            package="tf2_ros",
